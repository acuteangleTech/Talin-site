...
const WhatsAppIcon = () => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '00249912200031';
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 animate-fade-in-up">
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white rounded-full p-3 sm:p-4 shadow-lg hover:shadow-xl whatsapp-hover"
