...
const CompanyHeaderSection = () => {
  return (
    <section className="bg-global-1 pt-32 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Company Name */}
          <div className="text-center md:text-left">
            <h1 className="text-3xl md:text-3xl lg:text-3xl font-bold leading-tight bg-gradient-to-r from-[#666666] to-[#333333] bg-clip-text text-transparent whitespace-nowrap overflow-hidden">
              Talin International
            </h1>
          </div>
